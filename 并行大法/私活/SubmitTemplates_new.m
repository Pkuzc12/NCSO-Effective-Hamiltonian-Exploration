JobPath = '/gpfs/share/home/2000012425/homework';    % Please update your folder directory
cd(JobPath);
...
c.AdditionalProperties.JobName = 'homework';
c.AdditionalProperties.JobPriority = 'high';
...
j = batch(c,'main','Pool',63)    % Run a job for 63 works which is (64-1)
exit                                        
