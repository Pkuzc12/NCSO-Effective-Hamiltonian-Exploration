...
D=0.296;
    ...
    J2p=J2+(0.108+0.3);
    J1p=J1+(-2.37+3.02);
for Gs=(0.1895+0.237-0.1):0.1:(0.1895+0.237+0.1)
    Gps=Gs-0.1895;
...
for T=0.5:1:9.5
    ...
    toc
    Mb(int32((Gs-(0.1895+0.237-0.1))*10+1),int32(T+0.5))=sum(MMb)/(size*times);
    Ma(int32((Gs-(0.1895+0.237-0.1))*10+1),int32(T+0.5))=sum(MMa)/(size*times);
