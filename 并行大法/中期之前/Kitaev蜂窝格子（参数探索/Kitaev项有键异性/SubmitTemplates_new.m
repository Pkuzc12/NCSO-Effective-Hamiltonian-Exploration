JobPath = '/gpfs/share/home/2000012425/Kitaev';    % Please update your folder directory
cd(JobPath);
...
c.AdditionalProperties.JobName = 'Kitaev';
c.AdditionalProperties.JobPriority = 'normal';
