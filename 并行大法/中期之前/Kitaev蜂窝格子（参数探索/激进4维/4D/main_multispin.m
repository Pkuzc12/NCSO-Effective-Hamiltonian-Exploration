...
for T=0.5:1:9.5
    ...
    toc
    Mb(int32(J2*10+5),int32(J3*5-1),int32(K*20+4),int32(T+0.5))=sum(MMb)/(size*times);
    Ma(int32(J2*10+5),int32(J3*5-1),int32(K*20+4),int32(T+0.5))=sum(MMa)/(size*times);
