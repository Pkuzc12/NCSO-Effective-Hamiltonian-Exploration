JobPath = '/gpfs/share/home/2000012425/honeycomb_new';    % Please update your folder directory
cd(JobPath);
...
c.AdditionalProperties.JobName = 'honeycomb';
c.AdditionalProperties.JotPriority = 'high';
