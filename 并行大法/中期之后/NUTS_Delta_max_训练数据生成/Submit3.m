JobPath = '/gpfs/share/home/2000012425/NUTS_Delta_max_3';    % Please update your folder directory
cd(JobPath);
...
c.AdditionalProperties.JobName = 'NUTS8';
...
j = batch(c,'Main_FindDeltaMax_3','Pool',127)    % Run a job for 63 works which is (64-1)
exit                                        
