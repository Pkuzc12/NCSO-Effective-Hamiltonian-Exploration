JobPath = '/gpfs/share/home/2000012425/advanced';    % Please update your folder directory
cd(JobPath);
...
c.AdditionalProperties.JobName = 'adv';
...
j = batch(c,'main_multispin','Pool',31)    % Run a job for 63 works which is (64-1)
exit                                        
