JobPath = '/gpfs/share/home/2000012425/Mb_0.01K';    % Please update your folder directory
cd(JobPath);
...
c.AdditionalProperties.JobName = 'Mb_0.01K';
c.AdditionalProperties.JobPriority = 'low';
c.AdditionalProperties.Mail = '***@163.com';
c.AdditionalProperties.Partition = 'C032M0128G';
c.AdditionalProperties.NodeNum = '1';
c.AdditionalProperties.WorkerPerNode = '16'; 
c.AdditionalProperties.WallTime = '24:00:00';

j = batch(c,'GR_Digns','Pool',15)    % Run a job for 63 works which is (64-1)
exit                                        
